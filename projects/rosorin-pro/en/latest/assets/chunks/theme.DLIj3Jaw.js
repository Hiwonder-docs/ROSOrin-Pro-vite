...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.CX90mRTq.js"), true ? __vite__mapDeps([0,1]) : void 0));
  ...
  setup(__props) {
    ...
    async function submitFeedback() {
      ...
      try {
        ...
        statusMessage.value = result.msg || "Thanks for reaching out. We've received your question and will get back to you as soon as possible.";
        resetForm();
      } catch (error) {
        status.value = "error";
      ...
      return openBlock(), createElementBlock("div", {
        ...
        isOpen.value ? (openBlock(), createElementBlock("section", _hoisted_1, [
          ...
          createBaseVNode("form", {
            ...
            }, toDisplayString(status.value === "submitting" ? "Submitting..." : "Submit"), 9, _hoisted_2)
          ], 32)
        ])) : createCommentVNode("", true),
        createBaseVNode("button", {
