const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.DSfQBEsq.js","assets/chunks/framework.BuQn2Rj0.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.DSfQBEsq.js"), true ? __vite__mapDeps([0,1]) : void 0));
  ...
  setup(__props) {
    ...
    async function submitFeedback() {
      ...
      try {
        ...
        payload.append("source", "ROSOrin Pro docs");
